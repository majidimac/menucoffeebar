...
// Global formatters for better performance (reused across renders)
...
// Hoisted Admin components to prevent re-creation on every App render
const AdminLogin = React.memo(({ loginForm, setLoginForm, handleAdminLogin, loginError, setView }: any) => (
...
const AdminDashboard = React.memo(({ orders, setView, markOrderAsCompleted, deleteOrder }: any) => (
...
const App: React.FC = () => {
  ...
  const submitOrder = useCallback(() => {
    const newOrder: Order = {
      // Use slice and padEnd instead of substr for robustness
